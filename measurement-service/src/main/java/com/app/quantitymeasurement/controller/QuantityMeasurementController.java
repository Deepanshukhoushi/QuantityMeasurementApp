...
public class QuantityMeasurementController {
	...
	public ResponseEntity<?> performComparison(@Valid @RequestBody QuantityInputDTO input) {
		...
		log.debug("Compare details: thisQuantityDTO={}, thatQuantityDTO={}", input.getThisQuantityDTO(),
		...
		if (response.isError()) {
			throw new QuantityMeasurementException(response.getErrorMessage());
		}
	...
	public ResponseEntity<?> performConversion(@Valid @RequestBody QuantityInputDTO input) {
		...
		log.debug("Convert details: thisQuantityDTO={}, thatQuantityDTO={}, targetQuantityDTO={}",
